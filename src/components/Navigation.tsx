		...
		>
			<nav className="container mx-auto px-4">
				<div className="flex items-center justify-between">
					...
					{/* Mobile Menu */}
					<motion.div
						className={`fixed inset-0 glass-effect md:hidden ${
					...
					>
						<div className="flex items-center justify-center h-full">
							<div className="absolute top-full left-0 right-0 bg-black/60 backdrop-blur-md max-h-[80vh] overflow-y-auto">
								<ul className="space-y-8 text-center py-6">
									{navItems.map((item) => (
										<motion.li
											key={item.href}
